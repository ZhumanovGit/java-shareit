...
class ItemControllerTest {
    ...
    @Test
    public void getAllUserItems_whenRequestHasWrongSizeOrFrom_thenReturnStatus400() throws Exception {
    ...
    @Test
    public void searchItems_whenParamsAreWrong_thenReturnStatus400() throws Exception {
        mvc.perform(get("/items/search")
                        .header("X-Sharer-User-Id", 1L)
                        .param("text", "searchString")
                        .param("from", "-1")
    ...
    @Test
    public void createItem_whenRequestHasWrongBody_thenReturnStatus400() throws Exception {
        ItemCreateDto createDto = ItemCreateDto.builder()
                .description("desc")
                .requestId(1L)
                .available(true)
    ...
    @Test
    public void postComment_whenRequestHasWrongBody_thenReturnStatus400() throws Exception {
        CommentCreateDto createDto = CommentCreateDto.builder()
                .build();
